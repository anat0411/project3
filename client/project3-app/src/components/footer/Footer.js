          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <p className="textAbout">
                The company "Vacations on the Water" was founded by Kobi Locos
                in 1978, after he worked as a travel agent for two decades. The
                company was first based in Milan, but after 25 years moved to
                Rome, where it's based today. Since day one, the main thing we
                love offering to our costumers are amazing vacations on the
                water!
              </p>
            </div>
